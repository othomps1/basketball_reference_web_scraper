...
from basketball_reference_web_scraper.json_encoders.season_schedule import ScheduleJsonEncoder
...
def return_schedule(season_start_year):
    ...
    return SeasonSchedule(parsed_event_list, season_start_year=season_start_year, season_end_year=season_start_year + 1)
...
def return_json_encoded_schedule(season_start_year):
    ...
    return json.dumps(SeasonSchedule(parsed_event_list, season_start_year=season_start_year, season_end_year=season_start_year + 1), cls=ScheduleJsonEncoder)
